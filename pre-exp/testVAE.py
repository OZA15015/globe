...
class VAE(nn.Module):
    def __init__(self, z_dim):
        ...
        self.dense_enc1 = nn.Linear(50, 25)
        self.dense_enc2 = nn.Linear(25, 20)
        self.dense_encmean = nn.Linear(20, z_dim)
        self.dense_encvar = nn.Linear(20, z_dim)
        self.dense_dec1 = nn.Linear(z_dim, 20)
        self.dense_dec2 = nn.Linear(20, 25)
        #self.dense_dec3 = nn.Linear(200, 28*28)
        self.dense_dec3 = nn.Linear(25, 50)
